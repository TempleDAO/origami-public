...
interface IOrigamiCowSwapper is IConditionalOrder {
    ...
    /**
     * @notice On signature verification, the order sell amount has a sell amount less than
     * the configured `minSellAmount`
     */
    ...
    struct OrderConfig {
        ...
        // ---- END SLOT 2 (NB: there is 1 byte padded space here which could be used for future use if needed)
