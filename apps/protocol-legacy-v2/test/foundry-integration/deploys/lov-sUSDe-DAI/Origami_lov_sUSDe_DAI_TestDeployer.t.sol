...
import { Origami_lov_sUSDe_DAI_TestConstants as Constants } from "test/foundry-integration/deploys/lov-sUSDe-DAI/Origami_lov_sUSDe_DAI_TestConstants.t.sol";
...
contract Origami_lov_sUSDe_DAI_TestDeployer {
    ...
    OrigamiErc4626Oracle public sUsdeToDaiOracle;
    ...
    function deployForked(
...

        {
            ...
            swapper = new OrigamiErc4626AndDexAggregatorSwapper(owner, Constants.SUSDE_ADDRESS);
            OrigamiErc4626AndDexAggregatorSwapper(address(swapper)).whitelistRouter(Constants.ONE_INCH_ROUTER, true);
    ...
    function _postDeployLovToken() private {
        ...
        lovTokenManager.setOracles(address(sUsdeToDaiOracle), address(usdeToDaiOracle));
