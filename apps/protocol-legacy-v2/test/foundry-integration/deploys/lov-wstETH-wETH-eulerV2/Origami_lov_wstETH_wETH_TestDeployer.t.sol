...
struct LovTokenContracts {
    ...
    OrigamiLovTokenMorphoManager lovWstEthManager;
    OrigamiStableChainlinkOracle stEthToEthOracle;
    OrigamiWstEthToEthOracle wstEthToEthOracle;
    IOrigamiSwapper swapper;
    OrigamiEulerV2BorrowAndLend borrowLend;
}

/* solhint-disable max-states-count */
contract Origami_lov_wstETH_wETH_EulerV2_TestDeployer {
    ...
    OrigamiLovTokenMorphoManager public lovWstEthManager;
    ...
    OrigamiEulerV2BorrowAndLend public borrowLend;
    ...
    function getContracts()
        public
        view
        returns (ExternalContracts memory externalContracts, LovTokenContracts memory lovTokenContracts)
    {
        ...
        returns (ExternalContracts memory externalContracts, LovTokenContracts memory lovTokenContracts)
    {
        ...
        clStEthToEthOracle = new DummyOracle(
            DummyOracle.Answer({
                roundId: 18_446_744_073_709_552_516,
                answer: 0.9987854203488546e18,
                startedAt: 1_706_225_627,
                updatedAtLag: 1_706_225_627,
                answeredInRound: 18_446_744_073_709_552_516
            }),
            18
        );
    ...
    function _setuplovWstEth() private {
        stEthToEthOracle = new OrigamiStableChainlinkOracle(
            ...
            IOrigamiOracle.BaseOracleParams(
                "stETH/ETH", address(stEthToken), Constants.STETH_DECIMALS, address(wethToken), Constants.ETH_DECIMALS
            ),
        ...
        borrowLend = new OrigamiEulerV2BorrowAndLend(
            owner, // _initialOwner
            address(wstEthToken), // __supplyToken
            address(wethToken), // __borrowToken
            Constants.SUPPLY_WSTETH_VAULT_ADDRESS, // _supplyVault
            Constants.BORROW_WETH_VAULT_ADDRESS, // _borrowVault
            Constants.EULER_EVC // _ethereumVaultConnector
        );
        lovWstEthManager = new OrigamiLovTokenMorphoManager(
            owner,
            address(wstEthToken),
            address(wethToken),
            address(stEthToken),
    ...
    function _postDeploylovWstEth() private {
        ...
        lovWstEthManager.setFeeConfig(
            Constants.MIN_DEPOSIT_FEE_BPS, Constants.MIN_EXIT_FEE_BPS, Constants.FEE_LEVERAGE_FACTOR
        );
