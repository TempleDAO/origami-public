...
import { ExternalContracts, LovTokenContracts, Origami_lov_wstETH_wETH_TestDeployer as Deployer } from "test/foundry-integration/deploys/lov-wstETH-wETH-spark/Origami_lov_wstETH_wETH_TestDeployer.t.sol";
...
import { Origami_lov_wstETH_wETH_TestConstants as Constants } from "test/foundry-integration/deploys/lov-wstETH-wETH-spark/Origami_lov_wstETH_wETH_TestConstants.t.sol";
...
contract Origami_lov_wstETH_wETH_IntegrationTestBase is OrigamiTest {
    ...
    function rebalanceUpParams(
        ...
        params.collateralToWithdraw = LovTokenHelpers.solveRebalanceUpAmount(lovTokenContracts.lovWstEthManager, targetAL);
