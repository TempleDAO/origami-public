...
async function main() {
  ...
  const underlyingOracle = INSTANCES.ORACLES.PT_SUSDE_MAY_2025_DAI;
  ...
  await deployAndMine(
    'ORACLES.PT_SUSDE_MAY_2025_DAI_WITH_DISCOUNT_TO_MATURITY',
    factory,
    factory.deploy,
    {
      description: "PT-sUSDe-May2025/DAI / DISCOUNT_TO_MATURITY",
    ...
    ADDRS.ORACLES.PT_SUSDE_MAY_2025_DISCOUNT_TO_MATURITY,
    false // divide
  );
}
