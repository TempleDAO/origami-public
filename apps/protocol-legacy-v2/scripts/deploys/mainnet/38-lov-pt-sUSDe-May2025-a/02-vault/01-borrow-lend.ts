...
async function main() {
  ...
  await deployAndMine(
    'LOV_PT_SUSDE_MAY_2025_A.MORPHO_BORROW_LEND',
    factory,
    factory.deploy,
    ...
    ADDRS.EXTERNAL.MORPHO.ORACLE.PT_SUSDE_MAY_2025_DAI,
    ADDRS.EXTERNAL.MORPHO.IRM,
    DEFAULT_SETTINGS.LOV_PT_SUSDE_MAY_2025_A.MORPHO_BORROW_LEND.LIQUIDATION_LTV,
    DEFAULT_SETTINGS.LOV_PT_SUSDE_MAY_2025_A.MORPHO_BORROW_LEND.SAFE_LTV,
  );
}
