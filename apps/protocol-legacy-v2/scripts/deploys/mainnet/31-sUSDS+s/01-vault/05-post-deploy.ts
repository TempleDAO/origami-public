  ...
  await mine(
    INSTANCES.VAULTS.SUSDSpS.COW_SWAPPER.setOrderConfig(
      ADDRS.EXTERNAL.SKY.SKY_TOKEN,
      {
        ...
        limitPriceAdjustmentBps: DEFAULT_SETTINGS.VAULTS.SUSDSpS.COW_SWAPPERS.SKY_TO_USDS_EXACT_SELL_AMOUNT.LIMIT_PRICE_PREMIUM_BPS,
...
async function main() {
  ...
  await mine(
    INSTANCES.VAULTS.SUSDSpS.MANAGER.addFarm(
      ADDRS.EXTERNAL.SKY.STAKING_FARMS.STAKE_USDS_EARN_SKY,
      DEFAULT_SETTINGS.VAULTS.SUSDSpS.STAKING_FARMS.STAKE_USDS_EARN_SKY.REFERRAL_CODE,
    )
  );
