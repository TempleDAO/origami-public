...
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-oracles/01-pt-susde-may2025-usde-oracle.ts
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-oracles/02-pt-susde-may2025-dai-oracle.ts
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-oracles/03-pt-susde-may2025-discount-to-maturity.ts
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-oracles/04-pt-susde-may2025-dai-with-discount-to-maturity.ts
