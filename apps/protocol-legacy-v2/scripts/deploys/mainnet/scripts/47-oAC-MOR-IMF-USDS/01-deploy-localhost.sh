...
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-vault/04-post-deploy.ts
npx hardhat run --network localhost scripts/deploys/mainnet/$DIRECTORY/01-vault/05-seed-vault.ts
