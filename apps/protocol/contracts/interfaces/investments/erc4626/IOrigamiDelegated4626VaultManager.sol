...
interface IOrigamiDelegated4626VaultManager is IERC165 {
    ...
    function deposit(uint256 assetsAmount) external returns (uint256 assetsDeposited);
    ...
    function withdraw(uint256 assetsAmount, address receiver) external returns (uint256 assetsWithdrawn);
