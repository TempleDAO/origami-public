...
/// @dev The Owner will be the Origami Multisig, and only owner is able to upgrade.
/// Elevated Access will be granted to the OrigamiGmxManager and OrigamiGmxLocker/OrigamiGlpLocker
contract OrigamiGmxEarnAccount is IOrigamiGmxEarnAccount, Initializable, OrigamiElevatedAccessUpgradeable, UUPSUpgradeable {
    ...
    function harvestRewards(uint256 _esGmxVestingRate) external onlyElevatedAccess override returns (
        ...
        uint256 esGmxVesting;   
        {
            ...
            if (totalEsGmxClaimed != 0) {
                ...
                (esGmxReinvested, esGmxVesting) = totalEsGmxClaimed.splitSubtractBps(_esGmxVestingRate);
