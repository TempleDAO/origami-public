    ...
    function clone(address implementation, bytes memory data) internal returns (address instance) {
        ...
        unchecked {
            ...
            assembly {
                ...
                // 60 0x38     | PUSH1 0x38            | 0x38 extra              | [0, cds] = calldata // 0x38 (56) is
                // runtime size - data 36          | CALLDATASIZE          | cds 0x38 extra          | [0, cds] =
                // calldata
                ...
                // 3e          | RETURNDATACOPY        | success 0               | [0, rds] = return data (there might
                // be some irrelevant leftovers in memory [rds, cds] when rds < cds) 90          | SWAP1
                // | 0 success               | [0, rds] = return data
