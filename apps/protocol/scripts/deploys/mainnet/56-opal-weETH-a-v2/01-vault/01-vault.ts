...
async function main() {
  ...
  await deployAndMine(
    "VAULTS.OPAL_WEETH_A.TOKEN",
    factory,
    factory.deploy,
    await owner.getAddress(),
    DEFAULT_SETTINGS.VAULTS.OPAL_WEETH_A.TOKEN_NAME,
    DEFAULT_SETTINGS.VAULTS.OPAL_WEETH_A.TOKEN_SYMBOL,
    DEFAULT_SETTINGS.VAULTS.OPAL_WEETH_A.AUM_FEE_BPS,
