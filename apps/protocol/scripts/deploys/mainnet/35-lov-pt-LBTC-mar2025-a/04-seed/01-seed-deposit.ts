...
const TEST_SEED_WHALE = "0xEd0C6079229E2d407672a117c22b62064f4a4312";
...
async function main() {
  ...
  VAULT = INSTANCES.LOV_PT_LBTC_MAR_2025_A.TOKEN;
  ...
  if (network.name === 'localhost') {
    ...
    await mine(INSTANCES.EXTERNAL.PENDLE.LBTC_MAR_2025.PT_TOKEN.connect(signer).transfer(owner.getAddress(), DEFAULT_SETTINGS.LOV_PT_LBTC_MAR_2025_A.SEED_DEPOSIT_SIZE));

    await lovTokenSeedDepositTestnet(
      DEFAULT_SETTINGS.LOV_PT_LBTC_MAR_2025_A.SEED_DEPOSIT_SIZE, 
      await owner.getAddress(), 
      DEFAULT_SETTINGS.LOV_PT_LBTC_MAR_2025_A.MAX_TOTAL_SUPPLY
    )
  } else {
