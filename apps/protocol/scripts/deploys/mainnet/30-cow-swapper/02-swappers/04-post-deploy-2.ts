  ...
  await mine(
    INSTANCES.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.setOrderConfig(
      ADDRS.EXTERNAL.MAKER_DAO.SDAI_TOKEN,
      {
        ...
        limitPriceAdjustmentBps: DEFAULT_SETTINGS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.SDAI_SUSDE_MIN_BUY_AMOUNT.LIMIT_PRICE_PREMIUM_BPS,
  ...
  await mine(
    INSTANCES.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.setOrderConfig(
      ADDRS.EXTERNAL.MAKER_DAO.SDAI_TOKEN,
      {
        ...
        limitPriceAdjustmentBps: DEFAULT_SETTINGS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.SDAI_SUSDE_EXACT_SELL_AMOUNT.LIMIT_PRICE_PREMIUM_BPS,
  ...
  await mine(
    INSTANCES.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.setOrderConfig(
      ADDRS.EXTERNAL.ETHENA.SUSDE_TOKEN,
      {
        ...
        limitPriceAdjustmentBps: DEFAULT_SETTINGS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.SUSDE_SDAI_EXACT_SELL_AMOUNT.LIMIT_PRICE_PREMIUM_BPS,
  ...
  await mine(
    INSTANCES.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.setOrderConfig(
      ADDRS.EXTERNAL.ETHENA.SUSDE_TOKEN,
      {
        ...
        limitPriceAdjustmentBps: DEFAULT_SETTINGS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2.SUSDE_SDAI_MIN_BUY_AMOUNT.LIMIT_PRICE_PREMIUM_BPS,
