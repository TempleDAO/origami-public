...
import { Origami_lov_wstETH_wETH_TestConstants as Constants } from "test/foundry-integration/deploys/lov-wstETH-wETH-morpho/Origami_lov_wstETH_wETH_TestConstants.t.sol";
...
contract Origami_lov_wstETH_wETH_TestDeployer {
    ...
    function _postDeploylovWstEth() private {
        ...
        lovWstEthManager.setFeeConfig(Constants.MIN_DEPOSIT_FEE_BPS, Constants.MIN_EXIT_FEE_BPS, Constants.FEE_LEVERAGE_FACTOR);
