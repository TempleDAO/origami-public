...
contract ERC4626FuzzTest is ERC4626Test, OrigamiTest {
    ...
    function setUp() public override {
        ...
        vault = new MockErc4626VaultWithFees(origamiMultisig, "VAULT", "VLT", underlying, DEPOSIT_FEE, EXIT_FEE, MAX_SUPPLY);
    ...
    function setUpVault(Init memory init) public override {
        ...
        for (uint i = 0; i < N; i++) {
            ...
            // @note Updated: don't deposit for zero shares since we just revert anyway - make it a no-op instead
            if (shares > 0) {
