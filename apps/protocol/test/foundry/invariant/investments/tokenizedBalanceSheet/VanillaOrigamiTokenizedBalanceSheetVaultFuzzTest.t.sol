...
import {
    VanillaOrigamiTokenizedBalanceSheetVaultTestBase
} from "test/foundry/unit/common/tokenizedBalanceSheet/VanillaOrigamiTokenizedBalanceSheetVault.t.sol";
...
contract VanillaOrigamiTokenizedBalanceSheetVaultFuzzTest is
    VanillaOrigamiTokenizedBalanceSheetVaultTestBase,
    TokenizedBalanceSheetVaultTest
{
    ...
    function _excludeSelector(bytes4[] memory selectors) internal {
        StdInvariant.FuzzSelector memory excludedSelector =
            StdInvariant.FuzzSelector({ addr: address(0), selectors: selectors });
...
contract VanillaOrigamiTokenizedBalanceSheetVaultFuzzTestWithoutSharePrice is
    VanillaOrigamiTokenizedBalanceSheetVaultFuzzTest
{
