...
library OrigamiLovStEthTestConstants {
    /**
    ...
    uint16 public constant LOV_ETH_FEE_LEVERAGE_FACTOR = 15;
    uint16 public constant LOV_ETH_REDEEMABLE_RESERVES_BUFFER = 0; // 0%
    uint256 public constant LOV_ETH_PERFORMANCE_FEE_BPS = 500; // 5%
