...
//     IBeraRewardsVault internal constant beraRewardsVault =
// IBeraRewardsVault(0x7D949A79259d55Da7da18EF947468B6E0b34f5cf); IERC20 internal constant lpToken =
// IERC20(0xF7F214A9543c1153eF5DF2edCd839074615F248c);
...
//         validatorPubKey =
// "0x89c8b925d5d0e4233df6db338efc41a2529b31da77e088b03087ce9cd6f7f61552a806fdeced8d7a51ec5c6b4827e387"; }
...
//         impl = new OrigamiBeraBgtProxy(address(bgtToken));
//         vm.expectRevert(abi.encodeWithSelector(CommonEventsAndErrors.InvalidAccess.selector));
//         bgtProxy.upgradeToAndCall(address(impl),
// abi.encodeWithSelector(IOrigamiElevatedAccess.proposeNewOwner.selector, bob)); }
