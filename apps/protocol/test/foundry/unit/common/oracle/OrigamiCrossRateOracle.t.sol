...
contract OrigamiCrossRateOracleTestBase is OrigamiTest {
    ...
    function setupDaiUsdcOracle() internal {
        ...
        crOracle_1_2 = new OrigamiCrossRateOracle(
            IOrigamiOracle.BaseOracleParams("TOKEN1/TOKEN2", token1, 18, token2, 6),
            address(oOracle1),
            address(oOracle2),
            address(0)
        );
        ...
        crOracle_2_3 = new OrigamiCrossRateOracle(
            IOrigamiOracle.BaseOracleParams("TOKEN2/TOKEN3", token2, 6, token3, 6),
            address(oOracle2),
            address(oOracle3),
            address(0)
        );
        ...
        oOracle3_inverse = new OrigamiStableChainlinkOracle(
            origamiMultisig,
            IOrigamiOracle.BaseOracleParams("USD/TOKEN3", INTERNAL_USD_ADDRESS, 6, token3, 18),
        ...
        crOracle_1_2_3 = new OrigamiCrossRateOracle(
            IOrigamiOracle.BaseOracleParams("TOKEN1/TOKEN2/TOKEN3", token1, 18, token2, 6),
            address(oOracle1),
            address(oOracle2),
            address(oOracle3)
        );
...
contract OrigamiCrossRateOracleTestInit is OrigamiCrossRateOracleTestBase {
    ...
    function test_constructor_failure() public {
        ...
        // cross asset isn't in the second oracle
        {
            OrigamiStableChainlinkOracle oOracleX = new OrigamiStableChainlinkOracle(
                origamiMultisig,
                IOrigamiOracle.BaseOracleParams("TOKEN3/TOKEN2", token3, 18, token2, 6),
                0.99e18,
                address(oracle3),
                200 days,
                Range.Data(0.9e18, 1.1e18),
    ...
    function test_constructor_succeed_muldiv() public {
        ...
        // Multiply
        {
            oOracle2 = new OrigamiStableChainlinkOracle(
                origamiMultisig,
                IOrigamiOracle.BaseOracleParams("USD/TOKEN2", INTERNAL_USD_ADDRESS, 18, token2, 6),
                333e18,
                address(oracle2),
                100 days,
                Range.Data(0.9e18, 1.1e18),
...
contract OrigamiCrossRateOracleTestLatestPrice_1_2 is OrigamiCrossRateOracleTestBase {
    ...
    function test_latestPrice_success_2() public {
        // At floor
        oracle2.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 0.9e18, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        assertEq(
            crOracle_1_2.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN),
        ...
        // At ceiling
        oracle2.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 1.1e18, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        assertEq(
            crOracle_1_2.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN),
    ...
    function test_latestPrice_fail_denominator_zero() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IOrigamiOracle.InvalidPrice.selector, address(oOracle2), 0));
        crOracle_1_2.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN);
    }
    ...
    function test_spot_convertAmount_quoteToBase() public view {
        assertEq(
            crOracle_1_2.convertAmount(
                token2, 100e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            99.962509543413777798e18
        );
        assertEq(
            crOracle_1_2.convertAmount(
                token2, 100e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
        ...
        assertEq(
            crOracle_1_2.convertAmount(
                token2, 100e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            33_299.9999999999889444e18
        );
        assertEq(
            crOracle_1_2.convertAmount(
                token2, 100e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
    ...
    function test_spot_convertAmount_baseToQuote() public {
        ...
        assertEq(
            crOracle_1_2.convertAmount(
                token1, 99.962509543413777899e18, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            100e6
        );
        assertEq(
            crOracle_1_2.convertAmount(
                token1, 99.962509543413777899e18, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
            100e6 + 1
        );
...
contract OrigamiCrossRateOracleTestLatestPrice_2_3 is OrigamiCrossRateOracleTestBase {
    ...
    function test_latestPrice_success_3() public {
        // At floor
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 0.9e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        assertEq(
            crOracle_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN),
        ...
        // At ceiling
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 1.1e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        assertEq(
            crOracle_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN),
    ...
    function test_latestPrice_fail_denominator_zero() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IOrigamiOracle.InvalidPrice.selector, address(oOracle3), 0));
        crOracle_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN);
    }
    ...
    function test_spot_convertAmount_quoteToBase() public view {
        assertEq(
            crOracle_2_3.convertAmount(
                token3, 100e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            100.993314e6
        );
        assertEq(
            crOracle_2_3.convertAmount(
                token3, 100e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
            100.993315e6
        );
        ...
        assertEq(
            crOracle_2_3.convertAmount(
                token3, 100e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            0.297297e6
        );
        assertEq(
            crOracle_2_3.convertAmount(
                token3, 100e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
            0.297298e6
        );
    }
    ...
    function test_spot_convertAmount() public view {
        assertEq(
            crOracle_2_3.convertAmount(
                token2, 100.993315e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            100e6
        );
        assertEq(
            crOracle_2_3.convertAmount(
                token2, 100.993315e6, IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
            100e6 + 1
        );
        ...
        assertEq(
            crOracle_2_3.convertAmount(
                token2, 0.297297e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_DOWN
            ),
            99.999899e6
        );
        assertEq(
            crOracle_2_3.convertAmount(
                token2, 0.297297e6, IOrigamiOracle.PriceType.HISTORIC_PRICE, OrigamiMath.Rounding.ROUND_UP
            ),
            99.999901e6
        );
    }
...
contract OrigamiCrossRateOracleTestLatestPrice_1_2_3 is OrigamiCrossRateOracleTestBase {
    ...
    function test_pricecheck() public {
        ...
        // update answer
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 0.9989e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );

        // revert with BelowMinValidRange
        vm.expectRevert(
            abi.encodeWithSelector(IOrigamiOracle.BelowMinValidRange.selector, address(oracle3), 0.9989e18, 0.999e18)
        );
        crOracle_1_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN);
        ...
        // update answer
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 0.999e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        ...
        // update answer
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 1.111e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );
        assertEq(
            crOracle_1_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN),
            1.000375045172009612e18
        ...
        // update answer
        oracle3.setAnswer(
            DummyOracle.Answer({ roundId: 1, answer: 1.1111e24, startedAt: 0, updatedAtLag: 0, answeredInRound: 1 })
        );

        // revert with BelowMinValidRange
        vm.expectRevert(
            abi.encodeWithSelector(IOrigamiOracle.AboveMaxValidRange.selector, address(oracle3), 1.1111e18, 1.111e18)
        );
        crOracle_1_2_3.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN);
...
contract OrigamiCrossRateOracleTestLatestPrice_2_3_Multiply is OrigamiCrossRateOracleTestBase {
    ...
    function test_latestPrice_success_numerator_zero() public {
        ...
        assertEq(
            crOracle_2_3_inverse.latestPrice(IOrigamiOracle.PriceType.SPOT_PRICE, OrigamiMath.Rounding.ROUND_DOWN), 0
        );
    }
