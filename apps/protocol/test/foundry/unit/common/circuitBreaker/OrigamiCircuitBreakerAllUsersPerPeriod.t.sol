...
contract MockCaller {
    OrigamiCircuitBreakerAllUsersPerPeriod public breaker;

    function setBreaker(address _breaker) external  {
        breaker = OrigamiCircuitBreakerAllUsersPerPeriod(_breaker);
    }
...
contract OrigamiCircuitBreakerTestBase is OrigamiTest {
    ...
    function setUp() public {
        breaker = new OrigamiCircuitBreakerAllUsersPerPeriod(origamiMultisig, proxy, 1 days, 24, 100e18);
    }
}

contract OrigamiCircuitBreakerTestAccess is OrigamiCircuitBreakerTestBase {
...
contract OrigamiCircuitBreakerTestAdmin is OrigamiCircuitBreakerTestBase {
...
contract OrigamiCircuitBreakerTestPreCheck is OrigamiCircuitBreakerTestBase {
    ...
    function test_gas() public {
        ...
        breaker = new OrigamiCircuitBreakerAllUsersPerPeriod(origamiMultisig, address(caller), 1 days, 24, 100000e18);
    ...
    function test_preCheck_2day_8buckets() public {
        breaker = new OrigamiCircuitBreakerAllUsersPerPeriod(origamiMultisig, proxy, 2 days, 8, 100e18);
        vm.startPrank(proxy);
