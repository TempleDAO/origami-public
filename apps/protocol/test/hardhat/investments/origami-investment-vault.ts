...
describe("Origami Investment Vault", async () => {
    ...
    async function setup() {
        ...
        // Setup ovToken
        {
            ...
            ovToken = await new OrigamiInvestmentVault__factory(gov).deploy(govAddr, "ovToken", "ovToken", oToken.address, tokenPrices.address, 500, vestingDuration);
    ...
    it("constructor", async () => {
        ...
        await expect(
            new OrigamiInvestmentVault__factory(gov).deploy(govAddr, "ovToken", "ovToken", oToken.address, tokenPrices.address, 10_001, vestingDuration)
