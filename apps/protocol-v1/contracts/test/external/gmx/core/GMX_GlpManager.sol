...
import "./interfaces/GMX_IShortsTracker.sol";
...
contract GMX_GlpManager is GMX_ReentrancyGuard, GMX_Governable, GMX_IGlpManager {
    ...
    GMX_IShortsTracker public shortsTracker;
    ...
    constructor(address _vault, address _usdg, address _glp, address _shortsTracker, uint256 _cooldownDuration) public {
        ...
        usdg = _usdg;
        glp = _glp;
        shortsTracker = GMX_IShortsTracker(_shortsTracker);
    ...
    function setShortsTracker(GMX_IShortsTracker _shortsTracker) external onlyGov {
    ...
    function getPrice(bool _maximise) external view returns (uint256) {
        ...
        uint256 supply = GMX_IERC20(glp).totalSupply();
    ...
    function getGlobalShortAveragePrice(address _token) public view returns (uint256) {
        GMX_IShortsTracker _shortsTracker = shortsTracker;
